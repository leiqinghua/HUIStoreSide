...
- (void)setupView{
    ...
    _tableHeight = (_sheetTitle.length == 0)?(_cellCount*_cellHeight + _cancleHeight + SECTIONHEIGHT) + Height_Bottom_Margn:((_cellCount)*_cellHeight + _titleHeight + _cancleHeight + SECTIONHEIGHT*2) + Height_Bottom_Margn;
...
- (void)setSheetProperty{
    ...
    if (self.cancelFont){
        _cancleBtn.titleLabel.font = self.cancelFont;
    }
