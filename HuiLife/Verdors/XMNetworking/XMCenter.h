...
// NOTE: 以下属性只能通过调用' -setupConfig: '方法由' XMConfig '分配。

/**
 如果是XMRequest，则是XMCenter的一般服务器地址。服务器是“nil”和XMRequest。useGeneralServer是“YES”，这个属性将被分配给XMRequest.server。
 */
@property (nonatomic, copy, nullable) NSString *generalServer;

/**
 如果是XMRequest，则是XMCenter的一般参数。useGeneralParameters是' YES '，这个属性不是空的，它将被添加到XMRequest.parameters。
 */
