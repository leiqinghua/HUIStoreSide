...
{
    self = [super initWithFrame:CGRectMake(0, 0, kPICKVIEW_SCREEN_WIDTH, 43)];
...
//        [_leftButton setTitle:@"取消" forState:UIControlStateNormal];
        [_leftButton setImage:[UIImage imageNamed:@"close_x_grey"] forState:UIControlStateNormal];
...
- (UIButton *)rightButton
{
    if (!_rightButton) {
        ...
        [_rightButton setTitleColor:[UIColor hl_StringToColor:@"#FF8D26"] forState:UIControlStateNormal];
...
- (UILabel *)mainTitleLabel
{
    if (!_mainTitleLabel) {
        ...
        _mainTitleLabel.text = @"选择时间";
        _mainTitleLabel.textColor = [UIColor hl_StringToColor:@"#656565"];
        _mainTitleLabel.font = PickFont(17);
