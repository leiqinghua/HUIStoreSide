...
- (void)showWithMaxDateString:(NSString *)maxString withMinDateString:(NSString *)minString didSeletedDateStringBlock:(void (^)(NSString *dateString))dateStringBlock{
    self.limitDatePicker = [[LZCustomLimitDatePicker alloc]initWithPickerType:LZCustomLimitDateDefault];
...
*  dateStringBlock 选择日期回调
*/
- (void)showYearMonthWithMax:(NSString *)maxString withMinDateString:(NSString *)minString didSeletedDateStringBlock:(void (^)(NSString *))dateStringBlock {
    self.limitDatePicker = [[LZCustomLimitDatePicker alloc]initWithPickerType:LZCustomLimitDateYAM];
    [self.limitDatePicker showWithMaxDateString:maxString withMinDateString:minString didSeletedDateStringBlock:^(NSString *dateString) {
        if (dateStringBlock) {
            dateStringBlock(dateString);
        }
